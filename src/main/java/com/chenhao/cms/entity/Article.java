...
public class Article implements Serializable{
	...
	public String toString() {
		return "Article [id=" + id + ", title=" + title + ", summary=" + summary + ", content=" + content + ", picture="
				...
				+ hits + ", hot=" + hot + ", status=" + status + ", deleted=" + deleted + ", comment_num=" + comment_num
	...
	public Article(Integer id, String title, String summary, String content, String picture, Integer channelId,
			...
			Integer comment_num, Date created, Date updated, Channel channel, Category category, User user) {
		super();
		this.id = id;
		this.title = title;
		this.summary = summary;
